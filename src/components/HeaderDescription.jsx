        ...
        <div className="w-[100%]">
            <div className="container mx-auto">
                <div className="border-b border-light_gray pb-12 mb-12 lg:pb-24 lg:mb-24">
                    ...
                    <div className="flex flex-wrap sm:text-2xl text-xl text-black mt-5 font-normal tracking-wide">
                        <h4>Job title</h4>
                        <div className="mx-6">|</div>
                        <a className="cursor-pointer hover:underline">Link to your website</a>
                    </div>
                    <p className="sm:leading-10 leading-9 sm:text-2xl text-xl text-gray-400 mt-8 sm:mt-12 font-normal tracking-wide">
